    ...
    <div className="post-card">
      ...
      <div className="border-t grid grid-cols-3">
        {showAISuggestion ? (
          ...
          <button className="action-button font-medium text-gray-600 py-2 rounded-bl-lg flex items-center justify-center gap-1 md:gap-2 text-xs md:text-sm hover:bg-gray-100 transition-colors">
            <i className="fa-solid fa-heart text-red-500"></i> 
            Thích
          </button>
        )}
        <button className="action-button font-medium text-gray-600 py-2 flex items-center justify-center gap-1 md:gap-2 text-xs md:text-sm hover:bg-gray-100 transition-colors">
